defmodule HdseedTest do
  ...
  test "validate seed generation 3" do
    ...
    seed_bin = Hdseed.gen(mnemonic, "mnemonic")
    seed_hex = seed_bin |> Hdseed.to_hex()

    assert seed_hex ==
             "433db92c34f1001d93cc4458d887a18e008c95bd29cab2c65a062bd76036202268db5ae334fbb78d541c49084d0055b8d05f93966c88617de31cd5c5c7fd688f"
  end
  ...
  test "validate seed generation 4" do
    ...
    assert seed_hex ==
             "e9d8542adbfcaee0a5113cfcf3d30a49717c481ae3c958f22cddf90a2a8290ea85cae9f67dc7b3f85f6a7101b46f9019a2aadc79d11b1e81ba66ac085b854b5e"
  end

  test "validate seed generation 5" do
    mnemonic =
      "trigger allow add connect gossip island dumb stairs liberty surprise surround wedding"

    seed_bin = Hdseed.gen(mnemonic, "mnemonic")
    seed_hex = seed_bin |> Hdseed.to_hex()

    assert seed_hex ==
             "4d97a4b8a0ff4df3a1f0368308929d6d624ac08a75710d4476a97bbb8ab8286175bc1cce6133cd9b890d2b90e92e7892a8b464a368eb7b451e6c273ddf94952c"
  end
end
